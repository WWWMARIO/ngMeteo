import { GetLatestReadingForSensorPipe } from './get-latest-reading-for-sensor.pipe';

describe('GetLatestReadingForSensorPipe', () => {
  ...
  const pipe = new GetLatestReadingForSensorPipe();
  ...
  it('fetches latest reading for sensor id G4sLf9DOaxBOmjGLmDU8', () => {
  ...
  it('fetches latest reading for sensor id J2WEQArcfOdR67NrhcVE', () => {
  ...
  it('fetches latest reading for sensor id LY9xZ38Jq0iM1A4N2QZy', () => {
  ...
  it('fetches latest reading for sensor id j6jMOYDm3QJLkHrIrSLw', () => {

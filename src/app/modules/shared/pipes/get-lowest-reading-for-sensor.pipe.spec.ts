import { GetLowestReadingForSensorPipe } from './get-lowest-reading-for-sensor.pipe';
...
const pipe = new GetLowestReadingForSensorPipe();

describe('GetLowestReadingForSensorPipe', () => {
  it('create an instance', () => {
    expect(pipe).toBeTruthy();
  });

  it('fetches lowest reading for sensor id G4sLf9DOaxBOmjGLmDU8', () => {
  ...
  it('fetches lowest reading for sensor id J2WEQArcfOdR67NrhcVE', () => {
  ...
  it('fetches lowest reading for sensor id LY9xZ38Jq0iM1A4N2QZy', () => {
  ...
  it('fetches lowest reading for sensor id j6jMOYDm3QJLkHrIrSLw', () => {
